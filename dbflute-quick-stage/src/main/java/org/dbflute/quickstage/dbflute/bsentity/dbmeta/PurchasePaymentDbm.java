...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchasePaymentId = cci("PURCHASE_PAYMENT_ID", "PURCHASE_PAYMENT_ID", null, "購入支払ID", Long.class, "purchasePaymentId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_F9E5CC7A_9AD9_4322_A260_E1B74D098527", false, null, "連番", null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.quickstage.dbflute.exentity.PurchasePayment"; }
    public String getConditionBeanTypeName() { return "org.dbflute.quickstage.dbflute.cbean.PurchasePaymentCB"; }
    public String getBehaviorTypeName() { return "org.dbflute.quickstage.dbflute.exbhv.PurchasePaymentBhv"; }
