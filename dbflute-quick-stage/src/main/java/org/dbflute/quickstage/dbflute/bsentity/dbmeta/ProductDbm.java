...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, Integer.class, "productId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_8E48F453_C52F_48F8_B320_CAEB955100E5", false, null, null, null, "purchaseList", null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.quickstage.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "org.dbflute.quickstage.dbflute.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "org.dbflute.quickstage.dbflute.exbhv.ProductBhv"; }
