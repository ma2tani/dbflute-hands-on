...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchaseId = cci("PURCHASE_ID", "PURCHASE_ID", null, null, Long.class, "purchaseId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_40BABCB2_E40A_4754_93BE_9528AC0D18B0", false, null, null, null, "purchasePaymentList", null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.quickstage.dbflute.exentity.Purchase"; }
    public String getConditionBeanTypeName() { return "org.dbflute.quickstage.dbflute.cbean.PurchaseCB"; }
    public String getBehaviorTypeName() { return "org.dbflute.quickstage.dbflute.exbhv.PurchaseBhv"; }
