...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberServiceId = cci("MEMBER_SERVICE_ID", "MEMBER_SERVICE_ID", null, "会員サービスID", true, "memberServiceId", Integer.class, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_DFD66ADE_835A_45BF_8D9C_397DEAB7F9BB", false, null, "独立した主キーとなるが、実質的に会員IDとは one-to-one である。", null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.quickstage.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "org.dbflute.quickstage.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "org.dbflute.quickstage.dbflute.exbhv.MemberServiceBhv"; }
